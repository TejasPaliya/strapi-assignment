...
export interface ApiListingListing extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    BHKs: Schema.Attribute.Component<'bh-ks.bh-ks', true>;
    EMI: Schema.Attribute.String;
    Developer: Schema.Attribute.String;
    DevLogo: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    Thumbnail: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    MobileThumbnail: Schema.Attribute.Component<
      'shared.mobile-thumbnail',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
